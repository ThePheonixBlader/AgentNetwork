  ...
  extends TFM_Command
{
  public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
  {
    ...
    TFM_Util.bcastMsg("");
       ...
       TFM_Util.bcastMsg("");
       TFM_Util.bcastMsg("");
    TFM_Util.adminAction(sender.getName(), " Wanna know what happens when you mess with the mighty Alco_RS11? " + player.getName(), true);
   ...
   player.chat("YAYYYYYYYYYYY!!!!!!!!!");
    ...
    TFM_Util.bcastMsg(player.getName() + " HEY BITCH, NOW SEE WHATS ABOUT TO HAPPEN, NOW WITH  THE MIGHTY ALCO_RS11 ENRAGED?? ", ChatColor.RED);

...
@CommandParameters(
        description = "How to become administrator status",
        aliases = "admininfo,apply",
...
public class Command_ai extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.playerMsg(sender_p, "Well, you wish to become administrator, do you?", ChatColor.GOLD);
        TFM_Util.playerMsg(sender_p, "Well, apply at http://explodingfreedom.boards.net.net/ and look for something that states 'Admin Applications' and remember to follow the template!", ChatColor.GREEN);

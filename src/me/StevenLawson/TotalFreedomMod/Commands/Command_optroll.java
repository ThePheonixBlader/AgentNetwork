  ...
  extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole){
        ...
        if (!sender.getName().equalsIgnoreCase("KM_Galahad"))
        {
            
            TFM_Util.adminAction("WARNING: " + sender.getName(), "Has attempted to use /optroll. Alco_RS11 and Galahad have been notified.", true);
